...
--wf-tcp=80,443 --wf-udp=443,1400,596-599,50000-65535 ^
...
--filter-udp=1400,596-599,50000-65535 --ipset="%DISCORD_IPSET_PATH%" --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
